...
change = int(input(
    "Пепперони(это пицца с колбасками епт) - 1, 4 сыра(сэра в чтре раза бальше) - 2, барбека(в 2 раза больще мяса) - 3, гавайская(с энанасиками) - 4, маргарита(мэм такой ест) - 5"))
result = 0
i = 0
r = 0
d = 0
while i <= 1000:
    if change == 1:
        ...
        if size == 1:
            ...
            price = str(
                input("Стоимость выбранной пиццы составляет: 399.99 рублей. Добавить в корзину думай скорей(да/нет)"))
            money = 399.99
            if price == "да":
                result = result + money
            else:
    ...
    if drinks == "да":
        ...
        if change_drinks == 1:
            ...
            if size_of_drink == 0.3:
                price = str(
                    input("Стоимость напитка составляет: 59.99 рублей. Добавить в корзину думай скорее (да/нет)"))
                money = 59.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость напитка составляет: 79.99 рублей. Добавить в корзину думай скоре (да/нет)"))
                money = 79.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость напитка составляет: 99.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 99.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость напитка составляет: 149.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 149.99
                if price == "да":
                    result = result + money
                else:
...
while d <= 1000:
    ...
    if sweets == "да":
        ...
        if change_sweets == 1:
            ...
            if size_of_drink == 1:
                price = str(
                    input("Стоимость сладости составляет: 59.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 59.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость сладости составляет: 79.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 79.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость сладости составляет: 99.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 99.99
                if price == "да":
                    result = result + money
                else:
                ...
                price = str(
                    input("Стоимость сладости составляет: 149.99 рублей. Добавить в корзину думай скорей (да/нет)"))
                money = 149.99
                if price == "да":
                    result = result + money
                else:
